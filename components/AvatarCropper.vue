<script>
import { DraggableArea, DraggableElement, ResizeEvent, StencilPreview } from 'vue-advanced-cropper';
...
<template>
  <div class="circle-stencil" :style="style">
    <draggable-element class="circle-stencil__handler"> </draggable-element>
